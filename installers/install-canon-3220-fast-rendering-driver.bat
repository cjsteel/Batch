...
SET INSTALLER_EXE="C:\Program Files\7-Zip\7z" x ccdufr_2kxp2k3vista_ufr_0151_e.zip
SET PROGRAM_NAME=Install_Canon_3220_Ultra_Fast_Rendering_Drivers
...
SET ARCHIVE_SOURCE="\\mtl-fp\Data\sys\hw\printers\canon\irc3220\2k-xp-vista\ccdufr_2kxp2k3vista_ufr_0151_e.zip"
SET LOCAL_TARGET_DIRECTORY="C:\Data\sys\hw\printers\canon\3220\2k-xp-vista\UFR"
