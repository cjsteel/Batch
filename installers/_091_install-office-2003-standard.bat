...
SET INSTALLER_EXE="\\Mtl-fp\data\sys\sw\win\apps\lsi\en\MS Office 2003 Small Business Volume\STD11.MSI"
SET PROGRAM_NAME=MS_Office_2003_Small_Business_Volume
