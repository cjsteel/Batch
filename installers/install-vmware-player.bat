...
REM SET INSTALLER_EXE="\\mtl-fp\Data\sys\sw\win\apps\vmware\VMware Player\VMware-player-2.0.4-93057.exe"
REM SET INSTALLER_EXE="\\mtl-fp\Data\sys\sw\win\apps\vmware\VMware Player\VMware-player-2.0.5-109488.exe"
SET INSTALLER_EXE="\\mtl-fp\Data\sys\sw\win\apps\vmware\VMware Player\VMware-player-2.5.0-118166.exe"
SET PROGRAM_NAME=Install_VMware-player-2.0.5-109488
