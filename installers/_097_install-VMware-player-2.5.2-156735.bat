...
SET INSTALLER_EXE="\\mtl-fp\Data\sys\sw\win\apps\vmware\VMware Player\VMware-player-2.5.2-156735.exe"
SET PROGRAM_NAME=Install_VMware-player-VMware-player-2.5.2-156735.exe
